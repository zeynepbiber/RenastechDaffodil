...
public class lab11 {
    ...
    // Enter Any Customer id //After entering the customer ID, Click on the “Submit” button. //Reject/accept the alert.

    //  Task 2:
    //go to http://the-internet.herokuapp.com/hovers //move mouse to third image
    // (you may use move to element method in actions) //verify text of image present on the screen
    WebDriver driver;
